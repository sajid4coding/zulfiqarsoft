...
Route::get('service-details/{id}/{slug}', [FrontendController::class, 'service_details'])->name('service.details');
...
Route::get('blog-details/{id}/{slug}', [FrontendController::class, 'blog_details'])->name('blog.details');
