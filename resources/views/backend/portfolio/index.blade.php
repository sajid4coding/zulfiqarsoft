                            ...
                            @foreach ($portfolios as $portfolio)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-left align-items-center">
                                            <div class="d-flex flex-column">
                                                <a href="{{ route('portfolio.edit', $portfolio->id) }}" class="text-truncate fw-bold">{{ $portfolio->portfolio_title }}</a>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        @if ($portfolio->created_at->diffInDays(\Carbon\Carbon::now()) > 1 && $portfolio->portfolio_status == 'on')
                                            <span class="badge badge-success">Published</span>
                                        @endif
                                        @if ($portfolio->portfolio_status == NULL)
