...
@section('dashboard_content')
    ...
    <div class="layout-px-spacing">
        ...
        <div class="middle-content container-xxl p-0">
            ...
            <form action="{{ route('serviceCategory.update', $serviceCategory->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                        ...
                        <div class="widget-content widget-content-area blog-create-section">
                            ...
                            <div class="row my-4">
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" class="form-control" placeholder="Service Category Title" name="service_category_title" value="{{ $serviceCategory->service_category_title ? $serviceCategory->service_category_title : '' }}">
                                </div>
                                <div class="col-xxl-12 col-md-12 mt-4">
                                    @if ($serviceCategory->service_category_thumbnail)
                                        <div class="alert alert-primary alert-dismissible fade show mb-4" role="alert">
                                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><svg> ... </svg></button>
                                            <strong>Notice!</strong> Service Thumbnail Uploaded.
                                        </div>
                                    @endif
                            ...
                            <div class="row">
                                <div class="col-xxl-12 mb-4">
                                    <div class="switch form-switch-custom switch-inline form-switch-primary">
                                        <input class="switch-input" type="checkbox" role="switch" id="showPublicly" {{ $serviceCategory->service_category_status == 'on' ? 'checked' : '' }} name="service_category_status">
                                        <label class="switch-label" for="showPublicly">Publish</label>
                                    </div>
                                </div>

                                <div class="col-xxl-12 col-sm-4 col-12 mx-auto">
                                    <button type="submit" class="btn btn-success w-100">Update Service Category</button>
                                </div>
