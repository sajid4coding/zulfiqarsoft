...
@section('dashboard_header_css')
    ...
    <link href="{{ asset('dashboard_assets') }}/src/assets/css/light/dashboard/dash_1.css" rel="stylesheet" type="text/css" />
    <link href="{{ asset('dashboard_assets') }}/src/assets/css/dark/dashboard/dash_1.css" rel="stylesheet" type="text/css" />
                            ...
                            <div class="meta-info">
                                ...
                                <div class="avatar--group">
                                    ...
                                    <div class="avatar translateY-axis">
                                        <img alt="avatar" src="{{ asset('dashboard_assets') }}/src/assets/img/profile-8.jpeg"/>
                                    </div>
                                    <div class="avatar translateY-axis">
                                        <img alt="avatar" src="{{ asset('dashboard_assets') }}/src/assets/img/profile-12.jpeg"/>
                                    </div>
                                    <div class="avatar translateY-axis">
                                        <img alt="avatar" src="{{ asset('dashboard_assets') }}/src/assets/img/profile-19.jpeg"/>
                                    </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                    <div class="widget widget-card-one">
                        <div class="widget-content">
                            ...
                            <div class="media">
                                <div class="w-img">
                                    <img src="{{ asset('dashboard_assets') }}/src/assets/img/profile-19.jpeg" alt="avatar">
                                </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                    <div class="widget widget-card-two">
                        <div class="widget-content">
                            ...
                            <div class="media">
                                <div class="w-img">
                                    <img src="{{ asset('dashboard_assets') }}/src/assets/img/g-8.png" alt="avatar">
                                </div>
                                <div class="media-body">
                            ...
                            <div class="card-bottom-section">
                                ...
                                <div class="img-group">
                                    <img src="{{ asset('dashboard_assets') }}/src/assets/img/profile-19.jpeg" alt="avatar">
                                    <img src="{{ asset('dashboard_assets') }}/src/assets/img/profile-6.jpeg" alt="avatar">
                                    <img src="{{ asset('dashboard_assets') }}/src/assets/img/profile-8.jpeg" alt="avatar">
                                    <img src="{{ asset('dashboard_assets') }}/src/assets/img/profile-3.jpeg" alt="avatar">
                                </div>
...
@section('dashboard_footer_script')
    ...
    <script src="{{ asset('dashboard_assets') }}/src/assets/js/dashboard/dash_1.js"></script>
    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
@endsection
