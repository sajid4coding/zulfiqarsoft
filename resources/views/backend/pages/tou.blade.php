            ...
            <div class="page-meta">
                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ $tou->page_title }}</li>
                    </ol>
                </nav>
            </div>
            <!-- /BREADCRUMB -->
                        ...
                        <div class="widget-content widget-content-area blog-create-section">
                            ...
                            <div class="row mb-4">
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" class="form-control" id="post-title" placeholder="Page Title" name="page_title" value="{{ $tou->page_title }}">
                                </div>
                                @error('page_title')
                            ...
                            <div class="row mb-4">
                                <div class="col-sm-12">
                                    ...
                                    <textarea id="summernote" class="form-control" name="page_content" cols="30" rows="10" placeholder="Page Content">{{ $tou->page_content }}</textarea>
                                </div>
                                @error('page_content')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="widget-content widget-content-area blog-create-section mt-4">
                            ...
                            <div class="row mb-4">
                                <div class="col-xxl-12 mb-4">
                                    ...
                                    <input type="text" class="form-control" id="post-meta-title" placeholder="Meta Title" name="page_meta_title" value="{{ $tou->page_meta_title }}">
                                </div>
                                <div class="col-xxl-12">
                                    <label for="post-meta-content">Page Meta Content</label>
                                    <textarea class="form-control" id="post-meta-content" cols="10" rows="5" placeholder="Meta content" name="page_meta_content"> {{ $tou->page_meta_content }} </textarea>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xxl-12 mb-4">
                                    <div class="switch form-switch-custom switch-inline form-switch-primary">
                                        <input class="switch-input" type="checkbox" role="switch" id="showPublicly" {{ $tou->page_status == 'on' ? 'checked' : '' }} name="page_status">
