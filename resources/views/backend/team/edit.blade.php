                        ...
                        <div class="widget-content widget-content-area">
                            ...
                            <form action="{{ route('team.update', $team->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-4">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input-group social-fb mb-3">
                                                            ...
                                                            <input name="facebook" type="text" class="form-control" placeholder="Facebook Username" aria-label="Username" aria-describedby="fb" value="{{ $team->facebook }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="input-group social-tweet mb-3">
                                                            ...
                                                            <input name="twitter" type="text" class="form-control" placeholder="Twitter Username" aria-label="Username" aria-describedby="tweet" value="{{ $team->twitter }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input-group social-linkedin mb-3">
                                                            ...
                                                            <input name="linkedin" type="text" class="form-control" placeholder="Linkedin Username" aria-label="Username" aria-describedby="linkedin" value="{{ $team->linkedin }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input-group social-instagram mb-3">
                                                            ...
                                                            <input name="instagram" type="text" class="form-control" placeholder="instagram Username" aria-label="Username" aria-describedby="instagram" value="{{ $team->instagram }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input-group social-github mb-3">
                                                            ...
                                                            <input name="github" type="text" class="form-control" placeholder="Github Username" aria-label="Username" aria-describedby="github" value="{{ $team->github }}">
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-12 my-2">
                                        <select class="form-select" aria-label="Default select example" name="member_status">
                                            <option {{ $team->member_status == 'visible' ? 'selected' : '' }} value="visible">Visible</option>
                                            <option {{ $team->member_status == 'deactive' ? 'selected' : '' }} value="deactive">Deactive</option>
                                        </select>
                                    </div>
                                </div>
