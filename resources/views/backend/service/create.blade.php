        ...
        <div class="row mb-4 layout-spacing layout-top-spacing">
            ...
            <div class="col-xxl-9 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="widget-content widget-content-area blog-create-section mt-4">
                    ...
                    <textarea id="serviceDescription" class="form-control" name="serviceDescription" cols="30" rows="10" placeholder="Service Description"></textarea>
                ...
                <div class="widget-content widget-content-area blog-create-section mt-4">
                    ...
                    <div id="req_input" class="datainputs">
                        <div class="required_inp">
                            <input class="form-control my-1" name="stepTitle[]" placeholder="Step Title" type="text">
                            <textarea class="form-control my-1" name="stepDescription[]" placeholder="Step Description" cols="10" rows="2"></textarea>
                        </div>
                    </div>
                ...
                <div class="widget-content widget-content-area blog-create-section mt-4">
                    ...
                    <div id="req_input_faq" class="datainputs">
                        <div class="required_inp_faq">
                            <input class="form-control my-1" name="faqQuestion[]" placeholder="FAQ Question" type="text">
                            <textarea class="form-control my-1" name="faqAnswer[]" placeholder="FAQ Answer" cols="10" rows="2"></textarea>
                        </div>
                    </div>
                    <div class="d-grid gap-2 col-6 mx-auto">
