...
<link href="{{ asset('dashboard_assets') }}/src/plugins/src/notification/snackbar/snackbar.min.css" rel="stylesheet" type="text/css" />
...
<link rel="stylesheet" type="text/css" href="{{ asset('dashboard_assets') }}/src/assets/css/light/elements/alert.css">
                ...
                <div class="account-content">
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            @if (session('SocialMedia_success'))
                                <div class="alert alert-primary alert-dismissible fade show mb-4" role="alert">
                                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><svg> ... </svg></button>
                                    <strong>Success!</strong> {{ session('SocialMedia_success') }}.
                                </div>
                            @endif
                            @if (session('profile_status'))
                                <div class="alert alert-primary alert-dismissible fade show mb-4" role="alert">
                                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><svg> ... </svg></button>
                                    <strong>Success!</strong> {{ session('profile_status') }}.
                                </div>
                            @endif
                            @if (session('password_status'))
                                <div class="alert alert-primary alert-dismissible fade show mb-4" role="alert">
                                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><svg> ... </svg></button>
                                    <strong>Success!</strong> {{ session('password_status') }}.
                                </div>
                            @endif
                        ...
                        <div class="tab-pane fade show active" id="animated-underline-home" role="tabpanel" aria-labelledby="animated-underline-home-tab">
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                    ...
                                    <form id="social" class="section social" action="{{ route('password.update') }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input id="current_password" required class="form-control mb-3" name="current_password" type="password" autocomplete="current-password" placeholder="Current Password">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for="password">New Password</label>
                                                                <input id="password" required class="form-control mb-3" name="password" type="password" autocomplete="new-password" placeholder="New Password">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for="password_confirmation">Confirm Password</label>
                                                                <input id="password_confirmation" required class="form-control mb-3" name="password_confirmation" type="password" autocomplete="new-password" placeholder="Current Password">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12 mt-1">
                                                            <div class="form-group text-end">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                    ...
                                    <form id="social" class="section social" action="{{ route('account.social.setting.post') }}" method="POST">
                                        @csrf
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group social-fb mb-3">
                                                                ...
                                                                <input name="facebook" type="text" class="form-control" placeholder="Facebook Username" aria-label="Username" aria-describedby="fb" value="{{ $social_medias->facebook ? $social_medias->facebook : '' }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="input-group social-tweet mb-3">
                                                                ...
                                                                <input name="twitter" type="text" class="form-control" placeholder="Twitter Username" aria-label="Username" aria-describedby="tweet" value="{{ $social_medias->twitter ? $social_medias->twitter : '' }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group social-linkedin mb-3">
                                                                ...
                                                                <input name="linkedin" type="text" class="form-control" placeholder="Linkedin Username" aria-label="Username" aria-describedby="linkedin" value="{{ $social_medias->linkedin ? $social_medias->linkedin : '' }}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group social-instagram mb-3">
                                                                ...
                                                                <input name="instagram" type="text" class="form-control" placeholder="instagram Username" aria-label="Username" aria-describedby="instagram" value="{{ $social_medias->instagram ? $social_medias->instagram : '' }}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group social-github mb-3">
                                                                ...
                                                                <input name="github" type="text" class="form-control" placeholder="Github Username" aria-label="Username" aria-describedby="github" value="{{ $social_medias->github ? $social_medias->github : '' }}">
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="list-group mt-4">
                                                ...
                                                <label class="list-group-item">
                                                    <div class="d-flex w-100">
                                                        ...
                                                        <div class="payment-card">
                                                            <img src="{{ asset('dashboard_assets') }}/src/assets/img/card-mastercard.svg" class="align-self-center me-3" alt="americanexpress">
                                                        </div>
                                                        <div class="billing-content">
                                                ...
                                                <label class="list-group-item">
                                                    <div class="d-flex w-100">
                                                        ...
                                                        <div class="payment-card">
                                                            <img src="{{ asset('dashboard_assets') }}/src/assets/img/card-americanexpress.svg" class="align-self-center me-3" alt="americanexpress">
                                                        </div>
                                                        <div class="billing-content">
                                                ...
                                                <label class="list-group-item">
                                                    <div class="d-flex w-100">
                                                        ...
                                                        <div class="payment-card">
                                                            <img src="{{ asset('dashboard_assets') }}/src/assets/img/card-visa.svg" class="align-self-center me-3" alt="americanexpress">
                                                        </div>
                                                        <div class="billing-content">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="invoice-action-currency">
                                                            <div class="dropdown selectable-dropdown cardName-select">
                                                                <a id="cardBrandDropdown" href="javascript:void(0);" class="dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{ asset('dashboard_assets') }}/src/assets/img/card-mastercard.svg" class="flag-width" alt="flag"> <span class="selectable-text">Mastercard</span> <span class="selectable-arrow"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg></span></a>
                                                                <div class="dropdown-menu" aria-labelledby="cardBrandDropdown">
                                                                    <a class="dropdown-item" data-img-value="{{ asset('dashboard_assets') }}/src/assets/img/card-mastercard.svg" data-value="GBP - British Pound" href="javascript:void(0);"><img src="{{ asset('dashboard_assets') }}/src/assets/img/card-mastercard.svg" class="flag-width" alt="flag"> Mastercard</a>
                                                                    <a class="dropdown-item" data-img-value="{{ asset('dashboard_assets') }}/src/assets/img/card-americanexpress.svg" data-value="IDR - Indonesian Rupiah" href="javascript:void(0);"><img src="{{ asset('dashboard_assets') }}/src/assets/img/card-americanexpress.svg" class="flag-width" alt="flag"> American Express</a>
                                                                    <a class="dropdown-item" data-img-value="{{ asset('dashboard_assets') }}/src/assets/img/card-visa.svg" data-value="USD - US Dollar" href="javascript:void(0);"><img src="{{ asset('dashboard_assets') }}/src/assets/img/card-visa.svg" class="flag-width" alt="flag"> Visa</a>
                                                                    <a class="dropdown-item" data-img-value="{{ asset('dashboard_assets') }}/src/assets/img/card-discover.svg" data-value="INR - Indian Rupee" href="javascript:void(0);"><img src="{{ asset('dashboard_assets') }}/src/assets/img/card-discover.svg" class="flag-width" alt="flag"> Discover</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
