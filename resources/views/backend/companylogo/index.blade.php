        ...
        <div class="page-meta">
            <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Company Logos</li>
                </ol>
            </nav>
        </div>
        <!-- /BREADCRUMB -->
                ...
                <div class="widget-content widget-content-area br-8">
                    <table id="blog-list" class="table dt-table-hover" style="width:100%">
                        <div class="d-flex justify-content-center">
                            <a href="{{ route('companylogo.create') }}" class="btn btn-success text-center my-3">Company Logo Upload</a>
                        </div>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            @foreach ($companylogos as $companylogo)
                                <tr>
                                    ...
                                    <td>
                                        <span><img width="20%" src="{{ asset('storage/companylogo') }}/{{ $companylogo->companyLogo }}" alt="{{ $companylogo->companyLogo }}"></span>
                                    </td>
                                    <td class="text-center">
                                        <form action="{{ route('companylogo.destroy', $companylogo->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
