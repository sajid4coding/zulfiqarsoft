                ...
                <div class="col-lg-12 col-12 layout-spacing">
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area">
                            <div class="row mb-12">
                                <div class="col">
                                    <input name="under_logo_text" type="text" class="form-control" placeholder="Under Logo Text" value="{{ $general_setting->under_logo_text ? $general_setting->under_logo_text : '' }}">
                                    @error('under_logo_text')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            </div>
