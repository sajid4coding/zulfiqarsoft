                ...
                @foreach ($testimonials as $testimonial)
                    <div class="slider-for_item">
                        <div class="cs-testimonial cs-style1">
                            ...
                            <div class="cs-testimonial_text"> {{ $testimonial->client_message }} </div>
                            ...
                            <h2 class="cs-testimonial_avatar_name">{{ $testimonial->client_name }}</h2>
                            <div class="cs-testimonial_avatar_designation text-uppercase"> {{ $testimonial->client_position }} </div>
                        </div>
                    </div>
                @endforeach
            </div>
