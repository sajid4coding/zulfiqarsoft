...
<body>
    ...
    <footer class="cs-fooer">
        ...
        <div class="container">
            <div class="row">
                <div class="{{ App\Models\GlobalSettingStatus::find(1)->newsletter_section == NULL ? "col-lg-4" : "col-lg-3" }} col-sm-6">
                    ...
                    <div class="cs-text_widget">
                        ...
                        <p> {{ App\Models\GeneralSettings::find(1)->under_logo_text }} </p>
                    </div>
                    @if (App\Models\SocialMedia::find(1)->status == 'visible')
                        <div class="cs-social_btns cs-style1">
                            @if (App\Models\SocialMedia::find(1)->facebook)
                ...
                <div class="{{ App\Models\GlobalSettingStatus::find(1)->newsletter_section == NULL ? "col-lg-4" : "col-lg-3" }} col-sm-6">
                    ...
                    <ul class="cs-menu_widget cs-mp0">
                        @foreach ($services as $service)
                            <li>
                                <a href="{{ route('service.details', ['id' => $service->id, 'slug' => $service->service_category_slug]) }}">{{ $service->service_category_title }}</a>
                            </li>
                        @endforeach
                    </ul>
                    </div>
                ...
                @if (App\Models\GlobalSettingStatus::find(1)->newsletter_section == 'on')
