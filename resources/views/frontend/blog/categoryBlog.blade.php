    ...
    <div class="container">
      <div class="cs-page_heading_in">
        ...
        <ol class="breadcrumb text-uppercase">
          ...
          <li class="breadcrumb-item active">{{ $selectCategoryName->service_category_title }} - Blogs</li>
        </ol>
      </div>
    </div>
  </div>
              ...
              <div class="col-lg-8">
                 @if ($blogExists)
                    @foreach ($blogs as $blog)
                        ...
                        <a href="{{ route('blog.details',['id' => $blog->id, 'slug' => $blog->blogTitleSlug]) }}" class="cs-post_thumb cs-radius_15">
                        ...
                        <div class="cs-post_info">
                            ...
                            <a href="#" class="cs-post_avatar">{{ $blog->relationshipwithServiceCategory->service_category_title }}</a>
                            </div>
                            ...
                            <a href="{{ route('blog.details',['id' => $blog->id, 'slug' => $blog->blogTitleSlug]) }}" class="cs-text_btn">
                            <span>See More</span>
                ...
                @else
                    <span class="text-danger">Not Blog Uploaded Yet</span>
                @endif
             </div>
