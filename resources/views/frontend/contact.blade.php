...
@section('frontend_content')
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <ul class="cs-contact_info cs-style1 cs-mp0">
                    @if ($user->phone && $user->phone_status == 'visible')
                        <li>
                    ...
                    @endif
                    @if ($user->email && $user->email_status == 'visible')
                        <li>
                    ...
                    @endif
                    @if ($user->address && $user->address_status == 'visible')
                        <li>
    ...
    <div class="cs-google_map cs-bg" data-src="assets/img/map_img.jpeg">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d233667.49930141334!2d90.25487247764767!3d23.781067239454273!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b8b087026b81%3A0x8fa563bbdd5904c2!2sDhaka!5e0!3m2!1sen!2sbd!4v1720302734576!5m2!1sen!2sbd" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
