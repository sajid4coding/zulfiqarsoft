        ...
        <div class="cs-testimonial_slider">
            ...
            <div class="slider-nav cs-style1">
                ...
                <div class="slider-nav_item">
                    ...
                    <div class="cs-rotate_img_in">
                        <img src="{{ asset('frontend_assets') }}/img/testimonial_1.jpeg" alt="Nav Image" />
                    </div>
                    </div>
                </div>
                </div>
                ...
                <div class="slider-nav_item">
                    <div class="cs-rotate_img">
                    <div class="cs-rotate_img_in">
                        <img src="{{ asset('frontend_assets') }}/img/testimonial_2.jpeg" alt="Nav Image" />
                    </div>
                    </div>
                </div>
                </div>
                ...
                <div class="slider-nav_item">
                    <div class="cs-rotate_img">
                    <div class="cs-rotate_img_in">
                        <img src="{{ asset('frontend_assets') }}/img/testimonial_3.jpeg" alt="Nav Image" />
                    </div>
                    </div>
                </div>
                </div>
            ...
            <div class="slider-for cs-style1">
                ...
                <div class="cs-testimonial cs-style1">
                    ...
                    <div class="cs-rating_bg" data-src="{{ asset('frontend_assets') }}/img/rating.svg"></div>
                    <div class="cs-rating_percentage" data-src="{{ asset('frontend_assets') }}/img/rating.svg"></div>
                    </div>
