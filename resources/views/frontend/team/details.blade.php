      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 offset-xl-1">
          ...
          <div class="cs-section_heading cs-style1">
            <h2 class="cs-section_title">{{ $member->name }}</h2>
            <div class="cs-height_10 cs-height_lg_10"></div>
            <h3 class="cs-section_subtitle">{{ $member->position }}</h3>
            ...
            <p class="cs-m0">{{ $member->bio }}</p>
            <div class="cs-height_45 cs-height_lg_30"></div>
            @if ($member->social_account_status == 'visible')
                <div class="cs-social_btns cs-style1">
                    @if ($member->facebook)
                        <a href="https://www.facebook.com/{{ $member->facebook }}" target="_blank" class="cs-center">
                    ...
                    @if ($member->linkedin)
                        <a href="https://www.linkedin.com/in/{{ $member->linkedin }}" class="cs-center">
                    ...
                    @if ($member->twitter)
                        <a href="https://www.twitter.com/{{ $member->twitter }}" target="_blank" class="cs-center">
                    ...
                    @if ($member->instagram)
                        <a href="https://www.instagram.com/{{ $member->instagram }}" target="_blank" class="cs-center">
                    ...
                    @if ($member->github)
                        <a href="https://github.com/{{ $member->github }}" target="_blank" class="cs-center">
